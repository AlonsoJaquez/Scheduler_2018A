...
void PWM_Fan(const T_UBYTE percent)
...
void PWM_LedRed(void)
{
	ruw_ADC_Temperature = ADC16_GetChannelConversionValue(ADC0, ADC_CHANNEL_GROUP)/lub_percentdivisor;
	  /************************************************************************************
...
void PWM_LedGreen(T_UBYTE ruw_ADC_Temperature )
{

/************************************************************************************
*Update TPM2 Channel 1 or LED GREEN PORTB19
************************************************************************************/
/* Disable channel output before updating the dutycycle */
...
void PWMHandlerGreen()
{   ruw_dutycycle = ADC_Task();
	PWM_LedGreen(ruw_dutycycle);
}

void PWM_Resistor(const T_UBYTE percent)
{
	/* Disable channel output before updating the dutycycle */
